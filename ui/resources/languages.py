...
DASHBOARD_LANGS = {
    'TR': {
        ...
        'srv_kanban_restricted': "🔒 Kanban Panosu, Enterprise planına özeldir.",
        'srv_kanban_ad': "Ekibinizin verimliliğini artırmak için sınırsız panolara erişin!",
        'btn_upgrade_now': "🚀 Enterprise'a Yükselt",
        'btn_ad_close': "Reklamı Gizle",
        'btn_ad_show': "Reklamı Göster",
        'set_cat_system': "⚡ Sistem & Performans",
        'sys_title': "Performans Ayarları",
        'sys_gpu_title': "Grafik ve Görüntüleme (GPU)",
        'sys_gpu_chk': "Donanım Hızlandırmayı Kullan (Önerilen)",
        'sys_gpu_desc': "Arayüzün daha akıcı olması için ekran kartını (GPU) kullanır. Değişiklik yeniden başlatınca etkili olur.",
        'sys_cpu_title': "İşlemci ve Kaynak Kullanımı (CPU/RAM)",
        'sys_mode_lbl': "Güç Yönetimi Modu:",
        'sys_mode_eco': "Güç Tasarrufu (Düşük Kaynak)",
    ...
    'EN': {
        ...
        'srv_kanban_restricted': "🔒 Kanban Board is exclusive to Enterprise plan.",
        'srv_kanban_ad': "Unlock unlimited boards to boost your team's productivity!",
        'btn_upgrade_now': "🚀 Upgrade to Enterprise",
        'btn_ad_close': "Hide Ad",
        'btn_ad_show': "Show Ad",'set_cat_system': "⚡ System & Performance",
        'sys_title': "Performance Settings",
        'sys_gpu_title': "Graphics & Rendering (GPU)",
        'sys_gpu_chk': "Use Hardware Acceleration (Recommended)",
        'sys_gpu_desc': "Uses your graphics card (GPU) for a smoother interface. Requires restart.",
        'sys_cpu_title': "Processor & Resource Usage (CPU/RAM)",
        'sys_mode_lbl': "Power Management Mode:",
        'sys_mode_eco': "Power Saver (Low Resource)",
    ...
    'GER': {
        ...
        'srv_kanban_restricted': "🔒 Kanban Board ist exklusiv für den Enterprise-Plan.",
        'srv_kanban_ad': "Schalten Sie unbegrenzte Boards frei, um die Produktivität zu steigern!",
        'btn_upgrade_now': "🚀 Auf Enterprise upgraden",
        'btn_ad_close': "Werbung ausblenden",
        'btn_ad_show': "Werbung anzeigen",
        'set_cat_system': "⚡ System & Leistung",
        'sys_title': "Leistungseinstellungen",
        'sys_gpu_title': "Grafik & Rendering (GPU)",
        'sys_gpu_chk': "Hardwarebeschleunigung verwenden (Empfohlen)",
        'sys_gpu_desc': "Verwendet Ihre Grafikkarte (GPU) für eine flüssigere Oberfläche. Neustart erforderlich.",
        'sys_cpu_title': "Prozessor & Ressourcennutzung (CPU/RAM)",
        'sys_mode_lbl': "Energieverwaltungsmodus:",
        'sys_mode_eco': "Energiesparmodus (Geringe Ressourcen)",
